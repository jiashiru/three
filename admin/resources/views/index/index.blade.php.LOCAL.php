            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="graph_flot.html">添加新商品</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_morris.html">商品分类</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_rickshaw.html">商品类型</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_peity.html">商品品牌</a>
                        </li>
                    </ul>
                </li>
                <li class="line dk"></li>

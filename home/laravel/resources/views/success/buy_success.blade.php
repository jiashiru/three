...
<head>
    ...
    <script id="pageJS" language="javascript" type="text/javascript" data="http://skin.1yyg.net/MyCart/JS/ShopOK.js"></script>
</head>
<body id="loadingPicBlock">
<input name="hidShopID" type="hidden" id="hidShopID" value="170222085814339355" />
<input name="hidMobile" type="hidden" id="hidMobile" value="15373****63" />
    ...
    <div class="w1190 clrfix">
        ...
        <div id="divResult" class="g-main-con g-results-bor clrfix">
            ...
            <div id="divWx" class="g-wx-banner" style="display: none;">
                <img alt="" src="http://skin.1yyg.net/MyCart/images/wx-banner.jpg" />
            </div>

...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="http://skin.1yyg.net/CSS/GoodsList.css?date=150717" />
    <script language="javascript" type="text/javascript" src="http://skin.1yyg.net/JS/JQuery1.12.js"></script>
    <script id="pageJS" language="javascript" type="text/javascript" data="http://skin.1yyg.net/JS/GoodsList.js"></script>
</head>

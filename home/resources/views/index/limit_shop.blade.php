   ...
   <div class="m-list-classification clrfix">
        ...
        <div id="" class="announced-soon clrfix" style="">
            <?php foreach($goods as $k=>$v){ ?>
                <div class="soon-list-con" goodsid="23516" codeid="10595378" idx="{{$v

['times_id']}}">
                    <div class="soon-list">
                        <ul>
                            <li class="g-soon-pic">
                                <a title="(第{{$v['times']}}云) {{$v['goods_name']}} {{$v

['goods_desc']}}" target="_blank" href="indexShop?goods_id={{$v['goods_id']}}">
...
['goods_desc']}}" target="_blank" href="indexShop?goods_id={{$v['goods_id']}}">
                                    (第
                                    <em>{{$v['times']}}</em>
                                    云)  {{$v['goods_name']}}{{$v['goods_desc']}}
                                </a>
                            </li>
                            <li class="gray6">价值：￥{{$v['goods_price']}}.00
                                &nbsp;&nbsp;&nbsp;<font color= 'red'>
                                    <i > 限购</i>
                                    <b>{{$v['limit_num']}}</b>
                                    人次
                            ...
                            <li limitbuy="0" codeperiod="903" name="buyBox">
                                <a id="btnYgOneBuy" class="u-now" title="立即1元云购" 

href="javascript:;">立即1元云购</a>
                                <a class="u-cart" times_id="{{$v['times_id']}}" 

goods_id="{{$v['goods_id']}}" href="javascript:;">

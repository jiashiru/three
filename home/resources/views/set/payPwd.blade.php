            ...
            <ul class="fl">
                ...
                <li id="liCCTV" style="display: none;">
                    <a href="http://www.1yyg.com/url.html?t=8" target="_blank" class="cctv-icon" title="央视网">
                        <img src="{{asset('style/images/cctv-icon.jpg')}}" alt="央视网" width="80" height="35" class="cctv-icon-img">
                ...
                <li id="liMobile" class="u-arr">
                    ...
                    <div class="u-select">
                        ...
                        <a target="_blank" href="http://info.1yyg.com/app/mobile.html">
                            <img src="{{asset('public/style/images/app-qrcode.jpg')}}" alt="点击1元云购App">
                        </a>
                ...
                <div class="m-ser u-ser2">
                    <ul>
                        <li><a href="javascript:;">
                                <img src="{{asset('public/style/images/1yyg-wx.png?v=20141105')}}" /></a></li>
                        <li>
                            <dl>
                    ...
                    <ul>
                        ...
                        <li class="f-client">
                            ...
                            <div class="u-activate">
                                <a href="http://info.1yyg.com/app/mobile.html" target="_blank">
                                    <img src="{{asset('public/style/images/andriod.jpg?v=20141105')}}">
                                </a>
                            </div>
                        </li>
                        <li class="f-weixin">
                            ...
                            <div class="u-activate">
                                <a href="http://info.1yyg.com/app/microchannel.html" target="_blank">
                                    <img src="{{asset('public/style/images/1yyg-wx.png?v=20141105')}}"/>
                                    关注官方微信
                                </a>
                            </div>
                        </li>
